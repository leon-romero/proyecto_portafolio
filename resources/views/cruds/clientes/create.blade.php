                ...
                <form class="form-horizontal" method="post" action="{{ route('clientes.store') }}"  enctype="multipart/form-data">
                    ...
                    <div class="box-body">  
                        <div class="form-group {{ $errors->has('username') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputNombre" name="username" value="{{ old('username') }}" placeholder="Ingrese Nombre de Usuario...." required>
                        ...
                        <div class="form-group {{ $errors->has('correo') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="inputNombre" value="{{ old('correo') }}" name="correo" placeholder="Ingrese Correo...." required>
                        ...
                        <div class="form-group {{ $errors->has('nombre') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputNombre" name="nombre"  value="{{ old('nombre') }}" placeholder="Nombre Cliente...." required>
                        ...
                        <div class="form-group {{ $errors->has('apellidos') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputNombre" name="apellidos" value="{{ old('apellidos') }}" placeholder="Apellidos...." required>
                        ...
                        <div class="form-group {{ $errors->has('telefono') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="inputNombre" name="telefono" value="{{ old('telefono') }}" placeholder="Ingrese Teléfono...." required>
