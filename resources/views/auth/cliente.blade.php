...
<head>
  ...
  .imgFondo{
    ...
    /* min-height: 35rem; */
    /* padding: 15rem 0; */
    background: -webkit-gradient(linear, left top, left bottom, from(rgba(22, 22, 22, 0.1)), color-stop(75%, rgba(22, 22, 22, 0.5)), to(#161616)), url("/img/cliente2.jpg");
    background: linear-gradient(top bottom, rgba(22, 22, 22, 0.1) 0%, rgba(22, 22, 22, 0.5) 75%, #161616 100%), url("/img/cliente2.jpg");
