...
<section class="content-header">
    <h1>
        Formulario
        <small>Editar Tipo Producto</small>
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-success">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{ route('tipoproductos.update',$tipo->id_tipo_producto) }}">
                    {!! csrf_field() !!}
                    {!! method_field('PUT') !!}
                    <div class="box-body">
                        <div class="form-group {{ $errors->has('nombre_tipo') ? 'has-error' : '' }}">
                            <label for="inputNombre" class="col-sm-2 control-label"> Nombre</label>
                                <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputNombre" name="nombre_tipo" value="{{ $tipo->nombre_tipo }}" placeholder="Ingrese Nombre Tipo..." required>
                        ...
                        <div class="form-group {{ $errors->has('comentario') ? 'has-error' : '' }}">
                            <label for="inputNombre" class="col-sm-2 control-label">Descripcion</label>
                                <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputNombre" name="comentario" value="{{ $tipo->comentario }}" placeholder="Ingrese descripción...." required>
                        ...
                        <div class="form-group {{ $errors->has('precio_producto') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="inputNombre" name="precio_producto" value="{{ $tipo->precio_venta }}" placeholder="0" min="1" pattern="^[0-9]+" required>
                        ...
                        <div class="form-group {{ $errors->has('id_unidad') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="id_unidad" required>                                    
                                    ...
                                    @if ($u->id_unidad == $tipo->id_unidad)
                                    <option selected value="{{ $u->id_unidad }}">{{$u->nombre_unidad}}</option>
                                    @else
