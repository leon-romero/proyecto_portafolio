    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-warning">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{ route('prov.productos.update',$p->id_producto) }}">
                    {!! csrf_field() !!}
                    {!! method_field('PUT') !!}
                    <div class="box-body">
                        <div class="form-group  {{ $errors->has('id_tipo_producto') ? 'has-error' : '' }}">
                            <label for="inputTipoProd" class="col-sm-2 control-label">Producto</label>
                            <div class="col-sm-10">
                                <select class="form-control" id="select_tipo" onChange="buscarTiposProductos()" name="id_tipo_producto" required>
                                    @foreach ($tiposProducto as $tp)
                                    @if ($p->id_tipo_producto == $tp->id_tipo_producto)
                        ...
                        <div class="form-group  {{ $errors->has('nombre_producto') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" autocomplete="off" id="inputNombre" name="nombre_producto" value="{{ $p->nombre_producto }}" placeholder="Nombre Producto" required>
                        ...
                        <div class="form-group  {{ $errors->has('cantidad_stock') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control"  id="inputStock" name="cantidad_stock" value="{{ $p->cantidad_stock }}" placeholder="Cantidad Stock" required>
                        ...
                        <div class="form-group  {{ $errors->has('precio_compra') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="inputPrecio" name="precio_compra" value="{{ $p->precio_compra }}" placeholder="Precio Compra" required>
                        ...
                        <div class="form-group  {{ $errors->has('lugar_cultivo') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" autocomplete="off" class="form-control" id="inputLugar" name="lugar_cultivo" value="{{ $p->lugar_cultivo }}" placeholder="Lugar Cultivo" required>
                        ...
                        <div class="form-group  {{ $errors->has('comentario_prod') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" autocomplete="off" id="commentprod" name="comentario_prod" rows="5" maxlength="300" placeholder="comentario">{{ $p->comentario_prod }}</textarea>
