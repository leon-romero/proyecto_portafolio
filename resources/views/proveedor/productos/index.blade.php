      ...
      <div class="col-md-12">
        <div class="box">
          ...
          <div class="col-md-12 text-center">
            <a href="{{ route('prov.productos.create')}}" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-barcode"></i> Nuevo Producto</a>
          </div>
          <br>
          <br>
          <!-- /.box-header -->
              ...
              <tbody>
                @if (count($productos)>0 )
                  ...
                  <tr>                    
                    ...
                    <td>
                    <a href="{{ route('prov.productos.edit', $p->id_producto) }}" class="btn btn-primary btn-sm"> Editar <i class="fa fa-edit"></i> </a>
                    </td>
                    {{-- <td>
