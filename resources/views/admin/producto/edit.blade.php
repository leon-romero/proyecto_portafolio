                    ...
                    <div class="box-body">  
                        <div class="form-group">
                            <label for="inputNombre" class="col-sm-2 control-label">Nombre producto</label>
                                <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputNombre" name="nombre_producto" value="{{ $p->nombre_producto }}" placeholder="Ingrese nombre producto ...." required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputNombre" class="col-sm-2 control-label">Descripción</label>
                                <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputNombre" name="descripcion" value="{{ $p->descripcion }}"  placeholder="...." required>
                            </div>
                        </div>    
                        <div class="form-group">
                            <label for="inputNombre" class="col-sm-2 control-label">Stock</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="inputNombre" name="stock" placeholder="" value="{{ $p->stock }}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputNombre" class="col-sm-2 control-label">Stock Cricito</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="inputNombre" name="stock_critico" placeholder="" value="{{ $p->stock_critico }}" required>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
